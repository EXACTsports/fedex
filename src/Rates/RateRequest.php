...
class RateRequest
{
    public null | string $fedExAccountNumber = '';        // N - Customer's FedEx account number that can be used to pay for the order and for discounts
    public null | string $site = '';                      // N - The site through which the print order is being made
