...
$newLine = "<br />";
//
// Example of how to create an office order for pickup with a center id that will be selected based on provided search criteria
//
echo 'Example of how to create an office order for pickup with a center id that will be selected based on provided search criteria', $newLine, $newLine;
...
$minor = "0"; //as is
$customerTxnId = "Create Office Order v1 using PHP pickup center search";
...
$centerCountryCode = "center country code"; //for example, US
$centerDueDateTime = "YYYY-MM-DDTHH"; //for example, 2010-05-28T21
...
try 
{
	...
	//
	// Create an office order for pickup with a center id that will be selected based on provided search criteria
	//
    	echo $newLine, 'Creating an office order for pickup with a center id that will be selected based on provided search criteria...', $newLine, $newLine;
