...
$newLine = "<br />";
//
// Example of how to rate an office order for pickup based on a center id that is supplied in the request
//
echo 'Example of how to rate an office order for pickup based on a center id that is supplied in the request', $newLine, $newLine;
...
$minor = "0"; //as is
$customerTxnId = "Rate Office Order v1 using PHP with pickup center supplied";
...
$centerId = "known center id"; //e.g., 0512
...
try 
{
	...
	//
	// Rate an office order for pickup based on a center id that is supplied in the request
	//
    	echo $newLine, 'Rating an office order for pickup based on a center id that is supplied in the request...', $newLine, $newLine;
