...
require_once('D:\htdocs\PHP\LocationService\fedex-common.php5');

//The WSDL is not included with the sample code.
//Please include and reference in $path_to_wsdl variable.
$path_to_wsdl = "D:\WSDL_2020\LocationsService_v12.wsdl";
...
//	'SupportedRedirectToHoldServices' => array('FEDEX_EXPRESS', 'FEDEX_GROUND', 'FEDEX_GROUND_HOME_DELIVERY'),
	...
	//'LocationTypesToInclude' => array('FEDEX_AUTHORIZED_SHIP_CENTER')
